...
export const adminFailedLogs = {
  list: (page = 1, pageSize = 20) =>
    client.get('/admin/users/failed-logs/list', { params: { page, page_size: pageSize } }),
  resolve: (id: number) => client.put(`/admin/users/failed-logs/${id}/resolve`),
}
